        ...
        try:
            ...
            while True:
                ...
                if data:
                    ...
                    response_data = decoded_data.upper().encode()
                    connection.send(response_data)
                    print(f"(TCP) Gesendete Daten: {response_data} an {client_address}")
                else:
                    break
        finally:
...
def start_udp_server():
    ...
    while True:
        ...
        print(f"(UDP) Gesendete Daten: {response_data} an {client_address}")
